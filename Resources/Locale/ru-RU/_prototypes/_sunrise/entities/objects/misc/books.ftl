...
ent-BookDAM = Двигатель Антиматерии
    .desc = Данная книга рассказывает о сути работы одного из самых распространённых источников электроэнергии на объектах Фонда.
ent-BookFaks = Факс
...
ent-BookZP = Зарплатная система Фонда
    .desc = Данная книга рассказывает о том, как сотрудники Фонда получают зарплату.
...
ent-BookMBS2 = Блюспейс-маяки (ч.2)
    .desc = Как развивалась БС-технология дальних полётов? Как понять куда ты попадёшь? Об это рассказвается в данной книге.
ent-BookImplants = Устройство имплантов Фонда

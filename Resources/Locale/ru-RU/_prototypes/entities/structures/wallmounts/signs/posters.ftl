...
ent-PosterContrabandMissingGloves = Пропавшие перчатки
    .desc = Этот плакат описывает возмущение, возникшее после того, как Фонд сократил финансовые расходы на закупку изолирующих перчаток.
ent-PosterContrabandHackingGuide = Руководство по взлому
    .desc = Этот плакат подробно описывает внутреннюю работу стандартных воздушных шлюзов Фонда. К сожалению, он устарел.
ent-PosterContrabandRIPBadger = Спите спокойно, барсуки
    .desc = Этот провокационный плакат рассказывает о геноциде, устроенном Фондом на станции, полной барсуков.
...
ent-PosterContrabandPower = Мощь
    .desc = Плакат, который изображает власть за пределами Фонда.
...
ent-PosterLegitVacation = Корпоративные привилегии Nanotrasen: Отпуск
    .desc = На этом информационном плакате представлена информация о некоторых призах, которые можно получить в рамках программы 'Корпоративные привилегии Фонда', включая двухнедельный отпуск на двоих на планете-курорте Идиллус.

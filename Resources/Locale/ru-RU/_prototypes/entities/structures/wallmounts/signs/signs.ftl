...
ent-SignHead = знак "глава"
    .desc = Официальный знак, указывающий на место обитания сертифицированного Фондом руководителя отдела.
...
ent-SignZomlab = знак "зомби-лаборатория"
    .desc = Последние остатки закрытого исследовательского проекта Фонда, целью которого было использование силы Ромерола. Интересно, чем всё закончилось...

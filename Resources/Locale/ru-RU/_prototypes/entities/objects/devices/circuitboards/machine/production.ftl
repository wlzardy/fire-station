...
ent-MedicalScannerMachineCircuitboard = медицинский сканер (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
ent-CrewMonitoringServerMachineCircuitboard = сервер мониторинга персонала (машинная плата)
    .desc = Печатная плата для сервера мониторинга персонала.
...
ent-StationAnchorCircuitboard = ком якорь (машинная плата)

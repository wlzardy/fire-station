...
ent-MechNTGygax = Особый гигакс фонда SCP
    .desc = Козырь фонда SCP при решении проблем. Высокая прочность, повышенная защита от ударов, взрывов, температуры, выстрелов: обычных, лазерных и энергетических, а также расширенные слоты под оборудование позволяют перевернуть ситуацию в комплексе. Ускорители потребляют колоссальное количество энергии.

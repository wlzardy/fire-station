...
ent-ShippingContainerNanotrasen = грузовой контейнер Фонда
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображён логотип SCP, и поэтому внутри может быть что угодно.

...
ent-NTHandyFlag = ручной флажок Фонда
    .desc = Слава Фонду! Подождите, они реально сделали ручной флажок для корпорации?
ent-SyndieHandyFlag = ручной флажок Синдиката
    .desc = Для настоящих патриотов-бунтарей. Смерть Фонду!

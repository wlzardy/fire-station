...
ent-BookEngineersHandbook = Справочник инженера
    .desc = Справочник по инженерному делу, подготовленный Фондом.
ent-BookScientistsGuidebook = Справочник учёного
    .desc = Путеводитель по миру науки, подготовленный Фондом.
ent-BookSecurity = Безопасность 101
    .desc = Книга о безопасности на станции, подготовленная Фондом. Книга испачкана кровью. Похоже, что её больше использовали как оружие, чем как учебное пособие.
...
ent-BookSpaceLaw = Корпоративный закон
    .desc = Набор правил Фонда для поддержания закона и порядка на своих космических станциях.

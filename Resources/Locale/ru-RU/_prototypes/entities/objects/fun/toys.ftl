...
ent-PlushieNar = плюшевый Алый Король
    .desc = Маленькая плюшевая игрушка Алого Короля.
...
ent-BeachBall = пляжный мяч
    .desc = Простой пляжный мяч - один из самых популярных видов развлечения.
...
ent-BalloonNT = воздушный шарик Фонда
    .desc = Разработан специально для причинения максимального психологического вреда врагам фонда.

...
# Nanotrasen
marking-CyberlimbRArmNanotrasen = Протез, правая рука (Фонд)
marking-CyberlimbLArmNanotrasen = Протез, левая рука (Фонд)
marking-CyberlimbRHandNanotrasen = Протез, кисть правой руки (Фонд)
marking-CyberlimbLHandNanotrasen = Протез, кисть левой руки (Фонд)
marking-CyberlimbRLegNanotrasen = Протез, правая нога (Фонд)
marking-CyberlimbLLegNanotrasen = Протез, левая нога (Фонд)
marking-CyberlimbRFootNanotrasen = Протез, правая стопа (Фонд)
marking-CyberlimbLFootNanotrasen = Протез, левая стопа (Фонд)
marking-CyberlimbTorsoNanotrasen = Протез, туловище (Фонд)
# Xion

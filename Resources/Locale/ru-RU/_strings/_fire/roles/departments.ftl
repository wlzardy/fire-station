...
department-MobileTaskForce = Мобильная Оперативная Группа
department-MobileTaskForce-description = Группа быстрого реагирования для устранения чрезвычайных ситуаций в комплексе или проведения специальных операций.

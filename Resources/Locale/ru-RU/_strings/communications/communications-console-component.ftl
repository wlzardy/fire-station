...
comms-console-menu-broadcast-button-tooltip = Транслируйте ваше сообщение на настенные экраны по всему комплексу. Внимание: умещается только десять символов!

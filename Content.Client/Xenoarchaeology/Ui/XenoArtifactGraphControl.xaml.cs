...
public sealed partial class XenoArtifactGraphControl : BoxContainer
{
    ...
    public Color ActiveNodeColor { get; set; } = StyleNano.BloodRed; // Fire edit
    public Color UnlockedNodeColor { get; set; } = StyleNano.SCPWhite; // Fire edit
    public Color HoveredNodeColor { get; set; } = Color.DimGray;
    public Color UnlockableNodeColor { get; set; } = StyleNano.SCPWhite; // Fire edit
